...
document.querySelector("#mcq")
.addEventListener("mousemove", function(){
    document.querySelector("#slidephotos").style.marginTop = "0px"
    document.querySelector("#mcq").style.color = "rgb(177, 177, 177)"
})

document.querySelector("#mcq")
.addEventListener("mouseleave", function(){
    document.querySelector("#mcq").style.color = "initial"
})

document.querySelector("#bkick")
.addEventListener("mousemove", function(){
    document.querySelector("#slidephotos").style.marginTop = "-120%"
    document.querySelector("#bkick").style.color = "rgb(177, 177, 177)"
})

document.querySelector("#bkick")
.addEventListener("mouseleave", function(){
    document.querySelector("#bkick").style.color = "initial"
})

document.querySelector("#tracker")
.addEventListener("mousemove", function(){
    document.querySelector("#slidephotos").style.marginTop = "-240%"
    document.querySelector("#tracker").style.color = "rgb(177, 177, 177)"
})

document.querySelector("#tracker")
.addEventListener("mouseleave", function(){
    document.querySelector("#tracker").style.color = "initial"
})

document.querySelector("#stock")
.addEventListener("mousemove", function(){
    document.querySelector("#slidephotos").style.marginTop = "-360%"
    document.querySelector("#stock").style.color = "rgb(177, 177, 177)"
})

document.querySelector("#stock")
.addEventListener("mouseleave", function(){
    document.querySelector("#stock").style.color = "initial"
})
